...
# Diarization Tuning
scotus_ral = RefAudioLibrary(cases, path_out, rttm_path, sd_path, min_audio_len=mal)
eval_dict = {}
for d in tune_dt:
    for s in tune_sct:
        ...
        for wav in set_dict['d']:
            ...
            timelst = Diarize(scotus_ral, embed, info, sim_thresh=d, score_thresh=s)
